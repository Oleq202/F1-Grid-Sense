...
def build_pre_race_dataframe(year, grand_prix, history_years_back=5, overtaking_years_back=4, constructor_n_races=5):
    """Build race features using only data available after qualifying (no race session)."""
    ...
    weather_info = fetch_weather_data(q_session)
...
if __name__ == '__main__':
    test = build_pre_race_dataframe(2024, 'Monza')
    print(test)
